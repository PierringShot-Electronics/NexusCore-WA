...
GATEWAY_URL="${WHATSAPP_GATEWAY_HOST_URL:-http://localhost:${WHATSAPP_GATEWAY_PORT:-3001}}"
...
log "Checking WhatsApp gateway status..."
curl -fsS "${GATEWAY_URL}/api/server/status" >/dev/null
